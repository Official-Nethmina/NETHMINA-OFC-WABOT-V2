...
cmd({
  ...
  category: "download",
  filename: __filename
}, async (nethmina, mek, m, { from, q, sender, reply }) => {
...
cmd({
...
}, async (nethmina, mek, m, { body, sender, reply, from }) => {
  ...
  if (metadata.thumbnail) {
    await nethmina.sendMessage(from, { image: { url: metadata.thumbnail }, caption: msg }, { quoted: mek });
  } else {
    await nethmina.sendMessage(from, { text: msg }, { quoted: mek });
  }
  ...
  await nethmina.sendMessage(from, { text: qualityMsg }, { quoted: mek });
});
