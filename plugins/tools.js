...
cmd({
  ...
  try {
    ...
    await nethmina.sendMessage(from, { text: `╭〔 *🔒 Base64 Encode* 〕─⬣\n┃ Original: ${q.trim()}\n┃ Encoded: ${encoded}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try {
    ...
    await nethmina.sendMessage(from, { text: `╭〔 *🔓 Base64 Decode* 〕─⬣\n┃ Base64: ${q.trim()}\n┃ Decoded: ${decoded}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try {
    ...
    await nethmina.sendMessage(from, { text: `╭〔 *📝 JSON Formatter* 〕─⬣\n${formatted}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try {
    ...
    const buffer = fs.readFileSync(qrPath);
    await nethmina.sendMessage(from, { image: buffer, caption: `╭〔 *📶 Wi-Fi QR Code* 〕─⬣\n┃ SSID: ${ssid}\n┃ Security: ${type}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const binary = q.trim().split("").map(c => c.charCodeAt(0).toString(2).padStart(8,"0")).join(" ");
    await nethmina.sendMessage(from, { text: `╭〔 *💻 Text to Binary* 〕─⬣\n┃ Text: ${q.trim()}\n┃ Binary: ${binary}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const text = q.trim().split(" ").map(b => String.fromCharCode(parseInt(b,2))).join("");
    await nethmina.sendMessage(from, { text: `╭〔 *💻 Binary to Text* 〕─⬣\n┃ Binary: ${q.trim()}\n┃ Text: ${text}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const reversed = q.trim().split("").reverse().join("");
    await nethmina.sendMessage(from, { text: `╭〔 *🔄 Reverse Text* 〕─⬣\n┃ Original: ${q.trim()}\n┃ Reversed: ${reversed}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try {
    ...
    await nethmina.sendMessage(from, { text: `╭〔 *📡 Morse Encode* 〕─⬣\n┃ Text: ${q.trim()}\n┃ Morse: ${morse}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try {
    ...
    await nethmina.sendMessage(from, { text: `╭〔 *📡 Morse Decode* 〕─⬣\n┃ Morse: ${q.trim()}\n┃ Text: ${text}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const hex = Buffer.from(q.trim()).toString("hex");
    await nethmina.sendMessage(from, { text: `╭〔 *🧩 HEX Encode* 〕─⬣\n┃ Text: ${q.trim()}\n┃ HEX: ${hex}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const text = Buffer.from(q.trim(), "hex").toString("utf-8");
    await nethmina.sendMessage(from, { text: `╭〔 *🧩 HEX Decode* 〕─⬣\n┃ HEX: ${q.trim()}\n┃ Text: ${text}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const encoded = encodeURIComponent(q.trim());
    await nethmina.sendMessage(from, { text: `╭〔 *🌐 URL Encode* 〕─⬣\n┃ Text: ${q.trim()}\n┃ Encoded: ${encoded}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try { const decoded = decodeURIComponent(q.trim());
    await nethmina.sendMessage(from, { text: `╭〔 *🌐 URL Decode* 〕─⬣\n┃ Encoded: ${q.trim()}\n┃ Decoded: ${decoded}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  try {
    ...
    await nethmina.sendMessage(from, { text: `╭〔 *🌀 ROT13 Cipher* 〕─⬣\n┃ Input: ${q.trim()}\n┃ Output: ${rot13}\n╰───────────────⬣` }, { quoted: mek });
...
cmd({
  ...
  await nethmina.sendMessage(from, { text: `╭〔 *🔑 Random Password* 〕─⬣\n┃ Length: ${length}\n┃ Password: ${password}\n╰───────────────⬣` }, { quoted: mek });
});
...
cmd({
  ...
  await nethmina.sendMessage(from, { text: `╭〔 *📄 Lorem Ipsum* 〕─⬣\n${text.trim()}\n╰───────────────⬣` }, { quoted: mek });
});
...
cmd({
  ...
  await nethmina.sendMessage(from, { text: `╭〔 *🎨 Random Color* 〕─⬣\n┃ Hex: ${hex}\n╰───────────────⬣` }, { quoted: mek });
});
...
cmd({
  ...
  await nethmina.sendMessage(from, { text: `╭〔 *😎 Emoji Style* 〕─⬣\n${emojiText}\n╰───────────────⬣` }, { quoted: mek });
});
