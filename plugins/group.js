...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, isAdmins, reply, participants, quoted, args }) => {
  if (!isGroup || !isAdmins) 
  ...
  await nethmina.groupParticipantsUpdate(m.chat, [target], "remove");
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, isAdmins, reply, participants }) => {
...
cmd({
  ...
  category: "group",
  filename: __filename
}, async (nethmina, mek, m, { isGroup, isAdmins, reply, participants, args, quoted }) => {
  if (!isGroup) return reply("❌ This command can only be used in groups!");
  ...
  try {
    ...
    await nethmina.updateProfilePicture(m.chat, media);
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, reply, participants }) => {
...
async (nethmina, mek, m, { from, isGroup, isAdmins, reply, args }) => {
    try {
        ...
        await nethmina.groupParticipantsUpdate(from, [target], "add");
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, isAdmins, reply, quoted, args }) => {
  if (!isGroup || !isAdmins) 
    return reply("*Group only & both you and I must be admins.*");
  ...
  await nethmina.groupParticipantsUpdate(m.chat, [target], "promote");
...
cmd({
  ...
  await nethmina.groupParticipantsUpdate(m.chat, [target], "demote");
...
async (nethmina, mek, m, { from, isGroup, isAdmins, reply }) => {
    try {
        if (!isGroup) return reply("⚠️ This command can only be used in a group!");
        if (!isAdmins) return reply("⚠️ This command is only for group admins!");

        await nethmina.groupSettingUpdate(from, "not_announcement");
...
async (nethmina, mek, m, { from, isGroup, isAdmins, reply }) => {
    try {
        ...
        await nethmina.groupSettingUpdate(from, "announcement");
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, isAdmins, reply }) => {
  if (!isGroup || !isAdmins) 
    return reply("*Group only & both you and I must be admins.*");

  await nethmina.groupRevokeInvite(m.chat);
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, reply }) => {
  if (!isGroup) 
    return reply("*Group only & I must be an admin.*");

  const code = await nethmina.groupInviteCode(m.chat);
...
cmd({
  ...
  category: "group",
  filename: __filename,
}, async (nethmina, mek, m, { isGroup, isAdmins, args, reply }) => {
  if (!isGroup || !isAdmins) 
    return reply("*Group only & both you and I must be admins.*");

  if (!args[0]) return reply("*Give a new group name.*");

  await nethmina.groupUpdateSubject(m.chat, args.join(" "));
...
cmd({
  ...
  await nethmina.groupUpdateDescription(m.chat, args.join(" "));
...
cmd({
  ...
  const metadata = await nethmina.groupMetadata(m.chat);
